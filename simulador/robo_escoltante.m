classdef robo_escoltante
    ...
    methods
        ...
        function obj = controle_e_navegacao(obj,iteracao,tamos,tempo,fi_d,l_d,escoltado)
...
%             gamma_ei = (th_e + fi_ei) - th_i; 
            ...
            obj.Pdes = escoltado.Pos(1:2) + l_d.*[sin(-fi_d+th_e);cos(-fi_d+th_e)];
...
%             obj.plt.c = plot(obj.s2(1,:),obj.s2(2,:),'.','MarkerEdgeColor',obj.colors(2),'MarkerSize',7);
            ...
            obj.plt.d = plot(obj.hPos(1,:),obj.hPos(2,:),obj.colors(3+k));
