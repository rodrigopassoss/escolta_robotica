...
experimento.dx = 1100; %Posição de destino no eixo x [cm]
...
% VariÃ¡veis para a Modificação da Distância entre os robôs
...
mapabmp = 'mapa05.png'; % mapa do ambiente simulado (apenas para a simulação)
...
tempo_max = 150; % tempo máximo do experimento em segundos 
