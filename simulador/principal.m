...
experimento.e_dy = 250;


%% Posição de destino desejada do robô escoltado
experimento.dx = 800; %posição de destino no eixo x [cm]
...
experimento.l_ei = 60*ones(1,nRobos);
...
experimento.l_d = 30; % Distância inicial
...
mapabmp = 'mapa01.bmp'; % mapa do ambiente simulado (apenas para a simulação)
